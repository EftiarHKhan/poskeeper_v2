...
const tPrimaryColor = Color(0xFF851BFF);
...
const tGrayColor1 = Color(0xff6F6F6F);
const tGrayColor2 = Color(0xff9DB9DD);
const tBoarderLine = Color(0xFF448AFF);

const tGrayCholor2 = Colors.grey;